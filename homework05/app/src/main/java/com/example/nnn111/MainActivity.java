...
import com.example.nnn111.bean.UserInfo;
import com.example.nnn111.database.UserDBHelper;
import com.example.nnn111.util.DateUtil;
import com.example.nnn111.util.ViewUtil;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    // 初始化用户类型的下拉框
    private String[] typeArray = {"个人用户", "公司用户","学校用户", "18990158-倪晓阳"};
